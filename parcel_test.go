...
func TestAddGetDelete(t *testing.T) {
	...
	idParcel, error := store.Add(parcel)

	require.NoError(t, error)
	require.NotEqual(t, idParcel, 0)
...
func TestSetAddress(t *testing.T) {
	...
	err = store.SetAddress(idParcel, newAddress)
	require.NoError(t, err)
...
func TestSetStatus(t *testing.T) {
	...
	err = store.SetStatus(idParcel, ParcelStatusDelivered)
	require.NoError(t, err)
